  ...
  <div class="p-layout">
      ...
      <div class="p-layout-panel">
        <div class="p-layout-breadcrumb">
           <el-breadcrumb separator="/" style="float:left;line-height: inherit">
            <el-breadcrumb-item :to="{ path: '/index' }" v-if="!$menuArr || !$menuArr.length"><span class="first-page">欢迎</span></el-breadcrumb-item>
          ...
          <div class="p-layout-head">
            <el-dropdown class="is-user" @command="handleDropdown">
              <img src="../images/github.png" class="p-layout-avatar"> 
